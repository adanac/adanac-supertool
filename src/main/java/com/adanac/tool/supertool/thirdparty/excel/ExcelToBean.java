...
public class ExcelToBean {
	 ...
	 * @throws Exception
	 */
	public void readCellContent(String key, Field[] fields, Cell cell, Object obj, ExcelDataFormatter edf)
			throws Exception {
				...
				if (field.getName().equals(key)) {
					...
					if (field.getType().equals(Date.class)) {
						...
						if (o.getClass().equals(Integer.class)) {
							...
							// 检查是否需要转换
							if (bool) {
								field.set(obj, map.get(o.toString()) != null ? Integer.parseInt(map.get(o.toString()))
