...
public class ExcelUtil {
	 ...
	 * 导出没列的值
	 */
	public static String cellValue(int cellNumber, Employee dto) {
		String cellValue = "";
		switch (cellNumber) {
		case 0: {
			cellValue = dto.getName().toString();
			break;
		}
		case 1: {
			cellValue = dto.getAddress();
			break;
		}
		case 2: {
			cellValue = dto.getNumber() + "";
			break;
		}
		case 3: {
			cellValue = dto.getSSN() + "";
			break;
		}
		}
		return cellValue;
